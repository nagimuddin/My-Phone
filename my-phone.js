            ...
            <figure class="bg-slate-100 rounded-xl p-8 dark:bg-slate-800">
                ...
                <div class="pt-6 md:p-8 md:pb-0 text-center md:text-left space-y-4">
                    <figcaption class="font-medium text-center">
                        ...
                        <button type="button" onclick="loadMore('${phone.slug}')" class="text-white text-lg bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg px-8 py-3 text-center mt-5 mr-2 mb-2">Details</button>   
                    </figcaption>
                </div>
            </figure>
            `;
